					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						<div class="row align-items-center about-main-info">
							<div class="col-lg-6 col-md-6 col-sm-12">
								...
								Customers can view nearest driving class centres, available timing slots and Driving class fee packages, driving license fee packages, etc. Customer can apply for driving school and driving license through online.<br><br>
					...
					<div class="owl-carousel owl-theme">
						...
						<div class="item">
							<div class="serviceBox" style="height: 350px;">
								...
								<h3 class="title">Apply for Diving License</h3>
								<p class="description">
									This project
helps customer to apply for Driving License. To know about
the exact status of Driving License. 
								</p>
							</div>
						</div>
						<div class="item">
							<div class="serviceBox" style="height: 350px;">
								...
								<p class="description">
									The system generates invoice amount after sending driving class and driving license
request. 
								</p>
							</div>
						</div>
...
fee packages, and guide details. Even the customer can send request for driving
license.
								</p>
							</div>
						</div>
					...
					<div class="left-contact">
						<div class="media cont-line">
							...
							<div class="media-body dit-right">
								<h4>Address</h4>
ACS Driving ,<br>
Kambipura, Near RR Hospital,<br> Bangalore, Karnataka 560060
							</div>
						</div>
						<div class="media cont-line">
							<div class="media-left icon-b">
							...
							<div class="media-body dit-right">
								<h4>Email</h4>
								<a href="#">info@acsdrivingschool.com</a><br>
								<a href="#">contact@acsdrivingschool.com</a>
							</div>
						</div>
						<div class="media cont-line">
							<div class="media-left icon-b">
							...
							<div class="media-body dit-right">
								<h4>Phone Number</h4>
								<a href="#">95551 94820</a><br>78920 85554						</div>
						</div>
					</div>
				</div>
