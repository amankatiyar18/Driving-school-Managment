...
if(isset($_POST["btncustomerlogin"]))
{
	...
	if(mysqli_num_rows($qsql) == 1)
	{
		...
		$message = "Hello $rslogin[customer_name],<br>This email was sent from ACS Driving School website at $day $dt at $tim<br> You have Logged in successfully..
		<br><br>
...
<head>
    ...
    <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
     ...
     <!-- Site Metas -->
    <title>ACS Driving School</title> 
	...
	<div class="main-top">
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<div class="left-top">
						<a class="new-btn-d br-2" href="#"><span>Ph. 9555194820</span></a>
						<div class="mail-b"><a href="#"><i class="fa fa-envelope-o" aria-hidden="true"></i> contact@acsdrivingschool.com</a></div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="right-top">
...
?>
	...
	<header class="top-header">
		<nav class="navbar header-nav navbar-expand-lg">
            <div class="container">
				<a class="navbar-brand" href="index.php"><img src="images/acs.png" alt="image"></a>
