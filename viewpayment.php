			...
			<div class="row">
				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					<div class="blog-inner">
						<div class="item-meta">
							<a href="#"><i class="fa fa-eye"></i> <b>VIEW PAYMENT RECORDS</b> <i class="fa fa-eye"></i></a>
						</div>
						<p>
...
?>			
	...
	{	
	$sql = $sql . ",driving_class.*";
	}
	if(isset($_GET['dl_id']))
	{
	$sql = $sql . ",driving_license.*";
	}
	if(isset($_GET['class_id']))
	{
	$sql = $sql . ",employee.*";
	}
	$sql = $sql . ",branch.branch_name FROM payment"; 
	if(isset($_GET['class_id']))
	{	
