...
<center><a href='$url' style='text-decoration: none;'><H2>AVE MARIA DRIVING SCHOOL</H2></a></center>
...
if($arrmessage['date'] != "")
{
$mailmessage = $mailmessage . "<br><strong>Date:</strong> Caecuss, Dabico xx, XXXX<br><strong>Time</strong>: 9:00 am &#8211; 4:00 pm<br><br> <a style='color:#ffffff; background-color: #ff8300;  border: 10px solid #ff8300; border-radius: 3px; text-decoration:none;' href='#'>Download Now</a>";
}
